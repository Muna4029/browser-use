...
from pytest_httpserver import HTTPServer  # type: ignore[reportMissingImports]
...
class MockMCPServer:
	...
	def _setup_handlers(self):
		...
		@self.server.list_tools()  # type: ignore[reportAttributeAccessIssue]
		...
		@self.server.call_tool()  # type: ignore[reportAttributeAccessIssue]
...
async def test_mcp_tools_with_agent(test_mcp_server_script, httpserver: HTTPServer):
	...
	try:
		...
		from tests.ci.conftest import create_mock_llm  # type: ignore[reportMissingImports]
